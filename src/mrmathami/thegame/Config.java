...
public final class Config {
	 ...
	 * in other words, the texture will be display as it without scaling.
	 */
	public static final long TILE_VERTICAL = 22;
	/**
	...
	public static final double NORMAL_BULLET_SPEED = 0.9;//0.3;

	public static final long MACHINE_GUN_BULLET_TTL = 15;
	public static final long MACHINE_GUN_BULLET_STRENGTH = 20;
	public static final double MACHINE_GUN_BULLET_SPEED = 1.2;//0.4;

	public static final long SNIPER_BULLET_TTL = 60;
	public static final long SNIPER_BULLET_STRENGTH = 120;
	public static final double SNIPER_BULLET_SPEED = 1.5;//0.5;
	//endregion

	//region Tower
	public static final long NORMAL_TOWER_SPEED = 15;//30;
	public static final double NORMAL_TOWER_RANGE = 5.0;

	public static final long MACHINE_GUN_TOWER_SPEED = 3;//5;
	public static final double MACHINE_GUN_TOWER_RANGE = 4.0;

	public static final long SNIPER_TOWER_SPEED = 30;//60;
	public static final double SNIPER_TOWER_RANGE = 8.0;
	//endregion

	//region Enemy
	public static final double NORMAL_ENEMY_SIZE = 1.5;//0.9;
	...
	public static final double SMALLER_ENEMY_SIZE = 1.3;//0.7;
	...
	public static final double TANKER_ENEMY_SIZE = 1.7;//1.1;
